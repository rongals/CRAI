...
GNUTERM = "wxt"
plot '<(awk /mean/{print} ./results/crai/crai-8m32c4j-best.dat)' u 2:3 w l ti "best",\
     '<(awk /mean/{print} ./results/crai/crai-8m32c4j-fca.dat)' u 2:3 w l ti "fixed",\
     '<(awk /mean/{print} ./results/crai/crai-8m32c4j-swap.dat)' u 2:3 w l ti "swap",\
     '<(awk /mean/{print} ./results/crai/crai-8m32c4j-soar.dat)' u 2:3 w l ti "soar"
